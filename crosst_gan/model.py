    ...
    def __init__(
        ...
        if backend == "gpt2":
            ...
            try:
                ...
                # All BPE tokens are pooled; token_count is retained as the
                # semantic on/off ablation switch in CrossTGAN.
...
class CrossTGAN(nn.Module):
    """Method-aligned patch-domain CrossT-GAN generator."""
...
class MultiDomainCrossTGAN(nn.Module):
