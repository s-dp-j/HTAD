...
CrossT-GAN uses only GPT-2's tokenizer and token embedding matrix, not its
Transformer blocks.  This module reproduces that narrow path when the optional
``transformers`` package is unavailable in the legacy CPU environment.
"""
